...
def test_create_transaction(fantom, type, eth_tester_provider):
    tx = fantom.create_transaction(type=type)
...
def test_encode_transaction(type_, fantom, eth_tester_provider):
    ...
    actual = fantom.encode_transaction(address, abi, sender=address, type=type_)
